  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Sharing Application - Redefining Mobility for a Sustainable Future. Experience the Convenience of Shared Journeys Anytime, Anywhere."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Sharing Application - Redefining Mobility for a Sustainable Future. Experience the Convenience of Shared Journeys Anytime, Anywhere.`}
            </Text>
            <Box
